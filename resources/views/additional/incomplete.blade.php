<div class="col-md-4 bagian2">
    <div class="position-sticky bagian3 bagianex" style="top: 7rem;">

        <!--Calendar-->
        <div class="d-block position-static p-2 shadow rounded-3" style="background-color: white; margin-bottom: 20px;">
